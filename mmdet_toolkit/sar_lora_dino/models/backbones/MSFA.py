...
# All rights reserved.
#
# Portions are adapted from Meta research code (e.g. SlowFast operators).
# See `mmdet_toolkit/LICENSE` and `THIRD_PARTY_NOTICES.md` for details.
import math
import torch
