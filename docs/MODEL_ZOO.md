...
| --- | --- | --- | --- | --- |
| E0002 | DINOv3 ConvNeXt-S + LoRA (r=16, fc1+fc2), backbone frozen | `configs/sardet100k/dinov3_lora/retinanet_dinov3-timm-convnext-small_lora-r16_1x_sardet_bs64_amp.py` | `0.523 ± 0.028` (3 seeds) | Metrics: `artifacts/work_dirs/E0002_full_seed*/val_metrics.json` |
| E0003 | DINOv3 ConvNeXt-S linear probe (no LoRA), backbone frozen | `configs/sardet100k/dinov3_baselines/retinanet_dinov3-timm-convnext-small_linear-probe_1x_sardet_bs64_amp.py` | `0.419 ± 0.006` (3 seeds) | Metrics: `artifacts/work_dirs/E0003_full_seed*/val_metrics.json` |
| E0019 | DINOv3 ConvNeXt-S full fine-tune (no LoRA) | `configs/sardet100k/dinov3_baselines/retinanet_dinov3-timm-convnext-small_full-ft_1x_sardet_bs64_amp.py` | `0.572` | Metrics: `artifacts/work_dirs/E0019_full/val_metrics.json` |
| E0020 | ConvNeXt-S full fine-tune (supervised ImageNet) | `configs/sardet100k/sup_baselines/retinanet_timm-convnext-small_full-ft_1x_sardet_bs64_amp.py` | `0.594` | Metrics: `artifacts/work_dirs/E0020_full/val_metrics.json` |

## LoRA ablations (Val/Test)

| ID | Setting | Config | Val mAP | Test mAP | Metrics |
| --- | --- | --- | --- | --- | --- |
| E0004 | LoRA r=16, fc2-only | `configs/sardet100k/dinov3_lora_ablation/retinanet_dinov3-timm-convnext-small_lora-r16_fc2_1x_sardet_bs64_amp.py` | `0.507` | `0.483` | `artifacts/work_dirs/E0004_full/{val,test}_metrics.json` |
...
| E0016 | LoRA r=16, fc2-only + unfreeze stage3 | `configs/sardet100k/dinov3_lora_ablation/retinanet_dinov3-timm-convnext-small_lora-r16_fc2_unfreeze-stage3_1x_sardet_bs64_amp.py` | `0.569` | `0.543` | `artifacts/work_dirs/E0016_full/{val,test}_metrics.json` |
